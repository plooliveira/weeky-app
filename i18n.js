const translations = {
  "pt-BR": {
    ...
    home: {
      ...
      metaDescription: "Weeky é um planejador semanal para desktop que ajuda você a visualizar seu tempo, organizar prioridades e abrir espaço para o que importa.",
      eyebrow: "Uma visão mais ampla da semana",
      heroTitle: "Planeje sua semana com mais clareza.",
      heroDescription: "Visualize como seu tempo está distribuído, organize seus planos e abra espaço para o que importa, tudo em uma visão semanal simples e sem distrações.",
      allReleases: "Ver todas as versões",
      demoLabel: "Demonstração do planejador semanal Weeky",
      featuresEyebrow: "Clareza para fazer escolhas",
      featuresTitle: "Veja o todo antes de decidir os detalhes.",
      featureOneTitle: "A semana inteira à vista",
      featureOneDescription: "Organize blocos de tempo ao longo da semana e entenda seu planejamento de uma só vez.",
      ...
      ctaEyebrow: "Menos urgência, mais intenção",
      ctaTitle: "Abra espaço para o que importa nesta semana.",
      footerDescription: "Uma visão simples e clara da sua semana.",
    },
    privacy: {
      ...
      intro: "Esta política explica como o Weeky trata seus dados na versão atual do aplicativo.",
      lastUpdated: "Última atualização: 12 de julho de 2026",
      localTitle: "Seus dados ficam com você",
      ...
      analyticsTitle: "Sem rastreamento",
      analyticsDescription: "O Weeky não usa ferramentas de análise ou rastreamento dentro do aplicativo.",
      accountsTitle: "Use sem criar uma conta",
      accountsDescription: "O Weeky não exige uma conta nem informações pessoais para que você possa usar o aplicativo.",
  ...
  en: {
    ...
    home: {
      ...
      metaDescription: "Weeky is a weekly planner for desktop that helps you see your time, organize priorities, and make room for what matters.",
      eyebrow: "A wider view of your week",
      heroTitle: "Plan your week with greater clarity.",
      heroDescription: "See how your time is distributed, organize your plans, and make room for what matters, all in a simple, distraction-free weekly view.",
      allReleases: "View all releases",
      demoLabel: "Weeky weekly planner demonstration",
      featuresEyebrow: "Clarity to make better choices",
      featuresTitle: "See the whole before deciding the details.",
      featureOneTitle: "Your whole week at a glance",
      featureOneDescription: "Organize time blocks across the week and understand your plans all at once.",
      featureTwoTitle: "Categories that add context",
      featureTwoDescription: "Distinguish work, study, health, rest, and other important areas of your life.",
      featureThreeTitle: "Simple by design",
      featureThreeDescription: "A calm interface designed to keep your plans, not the app, at the center of your attention.",
      featureFourTitle: "Private by default",
      featureFourDescription: "Your planning data stays on your device and remains under your control.",
      printLabel: "FROM SCREEN TO PAPER",
      printTitle: "Your week, ready to go with you.",
      ...
      ctaEyebrow: "Less urgency, more intention",
      ctaTitle: "Make room for what matters this week.",
      footerDescription: "A simple, clear view of your week.",
    },
    privacy: {
      title: "Privacy Policy | Weeky",
      metaDescription: "Privacy Policy for Weeky, a weekly planner for desktop.",
      heading: "Privacy Policy",
      intro: "This policy explains how Weeky handles your data in the current version of the application.",
      lastUpdated: "Last updated: July 12, 2026",
      localTitle: "Your data stays with you",
